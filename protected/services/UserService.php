...
//        return SystemUser::getRoles($userId);
        return \app\ddd\Admin\Application\User\UserService::service()->getUserRoles($userId);
    }
...
//        return SystemUser::getMainRoleId($id);
        return \app\ddd\Admin\Application\User\UserService::service()->getUserMainRoleId($id);
