...
namespace ddd\Quota\Repository\LogisticsQuotaLimit;
...
class LogisticsQuotaLimitRepository extends EntityRepository implements ILogisticsQuotaLimitRepository
{
    use RedisCache;
    private $redisKey = '';
    ...
    {
        return new LogisticsQuotaLimit();
    }
    ...
    /**
     * 获取物流企业当前可用限额设置
     * @return bool|BaseEntity|LogisticsQuotaLimit|mixed|null
     * @throws \Exception
     */
     ...
     * 模型转换为实体
     * @param $model
     * @return \ddd\Common\Domain\BaseEntity|LogisticsQuotaLimit
     * @throws \Exception
     */
