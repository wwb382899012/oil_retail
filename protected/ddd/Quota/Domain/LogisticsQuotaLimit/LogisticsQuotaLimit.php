...
class LogisticsQuotaLimit extends BaseEntity implements IAggregateRoot
{
    ...
    {
        $this->code = 'WL' . IDService::getLogisticsQuotaLimitCodeId();
    }
    ...
    public static function create($rate)
    {
        ...
        $entity->generateCode();
        $entity->rate = $rate;
        $entity->setStatus(new Status(LogisticsQuotaLimitStatusEnum::Status_Saved));
