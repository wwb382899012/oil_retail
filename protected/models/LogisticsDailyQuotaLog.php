...
/**
 * This is the model class for table "{{logistics_daily_quota_log}}".
 *
 * The followings are the available columns in table '{{logistics_daily_quota_log}}':
 ...
 */
class LogisticsDailyQuotaLog extends BaseBusinessActiveRecord
{
	/**
	...
	{
		return '{{logistics_daily_quota_log}}';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('log_id, logistics_id, current_date, category, method, relation_id, quota, quota_total, status, status_time, remark, create_user_id, effect_time, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return LogisticsDailyQuotaLog the static model class
	 */
