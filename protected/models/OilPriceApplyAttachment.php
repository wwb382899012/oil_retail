...
/**
 * This is the model class for table "{{oil_price_apply_attachment}}".
 * The followings are the available columns in table '{{oil_price_apply_attachment}}':
 * @property integer $id
 ...
 */
class OilPriceApplyAttachment extends CActiveRecord{
    /**
     * Returns the static model of the specified AR class.
     * Please note that you should have this exact method in all your CActiveRecord descendants!
     * @param string $className active record class name.
     * @return OilPriceApplyAttachment the static model class
     */
    ...
    public function tableName(){
        return '{{oil_price_apply_attachment}}';
    }
