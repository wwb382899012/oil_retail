...
class SystemRole extends BaseActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array(
                'order_index, type, status, create_user_id, update_user_id',
                'numerical',
                'integerOnly' => true
            ),
            array(
            ...
            array(
                'role_id, name, order_index, type, status, remark, create_user_id, create_time, update_user_id, update_time',
                'safe',
                'on' => 'search'
            ),
        );
