...
/**
 * This is the model class for table "{{system_user_right}}".
 * The followings are the available columns in table '{{system_user_right}}':
 ...
 */
class SystemUserRight extends BaseActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * Please note that you should have this exact method in all your CActiveRecord descendants!
     * @param string $className active record class name.
     * @return SystemUserRight the static model class
     */
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array(
                'user_id, right_codes, remark, create_user_id, create_time, update_user_id, update_time',
                'safe',
                'on' => 'search'
            ),
        );
