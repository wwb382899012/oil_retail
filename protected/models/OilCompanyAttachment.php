...
/**
 * This is the model class for table "{{oil_company_attachment}}".
 * The followings are the available columns in table '{{oil_company_attachment}}':
 * @property integer $id
 ...
 */
class OilCompanyAttachment extends CActiveRecord{
    /**
     * Returns the static model of the specified AR class.
     * Please note that you should have this exact method in all your CActiveRecord descendants!
     * @param string $className active record class name.
     * @return OilCompanyAttachment the static model class
     */
