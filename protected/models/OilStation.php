...
/**
 * This is the model class for table "{{oil_station}}".
 * The followings are the available columns in table '{{oil_station}}':
 ...
 */
class OilStation extends CActiveRecord{
     ...
     * @return OilStation the static model class
     */
    ...
    public function rules(){
        ...
        return array(
            array(
                'apply_id, company_id, province_id, city_id, status, create_user_id, update_user_id',
                'numerical',
                'integerOnly' => true
            ),
            array(
            ...
            array(
                'station_id, apply_id, name, company_id, province_id, city_id, address, longitude, latitude, contact_person, contact_phone, remark, status, status_time, effect_time, create_time, create_user_id, update_user_id, update_time',
                'safe',
                'on' => 'search'
            ),
        );
    ...
    public function relations(){
        return array(
            ...
            'files'=> [self::HAS_MANY, OilStationAttachment::class,['base_id' => 'station_id'],'on'=> 'files.status = 1'],
